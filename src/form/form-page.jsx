...
export const FormPage = () => <RequestInformationContainer>
                <RequestInformationStyled>
                    <RequestInformationHeaderStyled>REQUEST INFORMATION</RequestInformationHeaderStyled>
                    <FormInputContainer>
                        ...
                        <Input placeholder='Program' required option={[1,2,3]} isDropdown={true} aria-label='Program' />
